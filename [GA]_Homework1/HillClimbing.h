...
public:
	...
	std::vector<bool> selectNeighbor(std::vector<bool>, size_t);
	std::vector<bool> improveBest(std::vector<bool>,size_t);
	std::vector<bool> improveFirst(std::vector<bool>, size_t);
